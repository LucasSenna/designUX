    ...
    <div id="main">
        ...
        <div class="main-content container-fluid">
            <div class="page-title">
                ...
                <div>
                    <p class="SubTitulo">1918 - Primeira Guerra Mundial</p>
                    <p class="Texto">Com a Primeira Guerra Mundial, houve um aumento da importância de carros e aviões, e a emergência em estabelecer a nova ciência “human factors”, ou “<em>fatores humanos</em>” em português. As metodologias e insights da ergonomia e da psicologia foram usados para entender como as pessoas se comportavam enquanto utilizavam ferramentas complexas e submetidas a diferentes ambientes (Macedo, 2014).</p>
                    <hr>
